...
def find_qp(yaw):
    ...
    if -10 < yaw and yaw < 10:
        ...
        for i in range(4):
            cross_z.append(cross_j[i])
            cross_z.append(cross_sz[i])
        cross_z.append(cross_j[4])
        return cross_z
#        for m in cross_z:
#            print("cs", m)
#        print("_____________")
...
#    unique_list.clear()
#    for o in blobs_O:
#        if o not in cross_z4:
#            unique_list.append(o)

#    unique_list1 = []
#    unique_list1.clear()
#    for p in blobs_X:
#        if p not in cross_z4:
#            unique_list1.append(o)


#    print("棋盘： ", cross_z3[0], cross_z3[1], cross_z3[2])
#    print("棋盘： ", cross_z3[3], cross_z3[4], cross_z3[5])
#    print("棋盘： ", cross_z3[6], cross_z3[7], cross_z3[8])
#    for q in unique_list:
#        print("bai",q)
#    for r in unique_list1:
#        print("hei",r)
